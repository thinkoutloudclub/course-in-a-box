...
Open Badges can be issued by anyone. The system is built on an open standard that is owned by the community, with the technology supported by the Mozilla Foundation. That means that the 'value' of a badge comes through a combination of the 'brand recognition' of the issuer and the rigour of the criteria. 
