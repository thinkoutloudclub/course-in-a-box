...
So the biggest and most important difference between an Open Badge and a digital badge is that the former is full of useful information that can be tracked back to an individual badge earner. A digital badge, on the other hand, lacks this metadata and can be copied by those who did not themselves earn it. 
